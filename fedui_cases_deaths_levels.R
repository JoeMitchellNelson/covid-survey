...
#################### READ IN DATA ################
{
  ...
  dat$mabscases <- dat$mabscases # currently in 100s of cases per 50k, divide by 10 to get 1000s of cases per 50k
...
getsummary <- function (fac,df) {
  ...
  bv <- c(paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"mabscases"),
          paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"mabsdeaths"),
          paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"avcost"),
          paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"unempl"),
          paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"statquo"),
          "rule1.1",           "rule1.2",          
...
maketable <- function (fac,df,drop=c("MISSING")) {
  ...
  vars.order <- c(paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"mabscases"),
                  paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"mabsdeaths"),
                  paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"avcost"),
                  paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"unempl"),
                  paste0(c("feduinone","fedui100","fedui200","fedui300","fedui400"),"statquo"))
  
  fake <- lm(as.formula(paste0("best ~ ", paste(vars.order,collapse=" + "),"+ 0")),data = df)
  ...
  b <- stargazer(mods,type="latex",title=str_to_title(fac),
                 ...
                 no.space = T,
                 t.auto = T,
                 dep.var.labels = "1 = Preferred alternative") %>% 
...
fixnames <- function (x) {
  ...
  for (i in c(100,200,300,400)) {
    x <- str_replace_all(x,paste0("fedui",i,"mabscases"),paste0("Cases, 100s per 50K (federal UI = ",i,")"))
    x <- str_replace_all(x,paste0("fedui",i,"mabsdeaths"),paste0("Deaths per 50K (federal UI = ",i,")"))
    x <- str_replace_all(x,paste0("fedui",i,"avcost"),paste0("Avg. hhld cost (federal UI = ",i,")"))
    x <- str_replace_all(x,paste0("fedui",i,"unempl"),paste0("Unempl rate (federal UI = ",i,")"))
    x <- str_replace_all(x,paste0("fedui",i,"statquo"),paste0("1 = Status quo alternative (federal UI = ",i,")"))
  }
  
  x <- str_replace(x,"centering","centering \\\\scriptsize")
...
write(ideoltable,file="~/covid-survey/tables/ideologytable_casesdeaths_levels.tex")
...
write(gendertable,file="~/covid-survey/tables/gendertable_casesdeaths_levels.tex")
...
write(agetable,file="~/covid-survey/tables/agetable_casesdeaths_levels.tex")
...
write(racetable,file="~/covid-survey/tables/racetable_casesdeaths_levels.tex")
...
write(eductable,file="~/covid-survey/tables/educationtable_casesdeaths_levels.tex")
...
cat(incometable)
write(incometable,file="~/covid-survey/tables/incometable_casesdeaths_levels.tex")
